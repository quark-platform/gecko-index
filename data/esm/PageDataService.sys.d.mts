...
export const PageDataService: {
     ...
     */
    "__#543867@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#543867@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#543867@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#543867@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
