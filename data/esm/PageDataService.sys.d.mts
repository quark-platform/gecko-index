...
export const PageDataService: {
     ...
     */
    "__#567326@#backgroundBrowsers": WeakMap<Browser, (arg0: PageDataParent) => void>;
    /**
     * Tracks windows that have browsers with entries in the cache.
     *
     * @type {Map<Window, Set<Browser>>}
     */
    "__#567326@#trackedWindows": Map<Window, Set<Browser>>;
    /**
     ...
     */
    "__#567326@#trackBrowser"(browser: Browser): void;
    /**
     ...
     */
    "__#567326@#isATabBrowser"(browser: DOMElement): boolean;
};
/**
