...
export class TranslationsParent {
     ...
     */
    static "__#653@#previousDetectedLanguages": LangTags | null;
    /**
     * The remote settings client that retrieves the language-identification model binary.
     *
     * @type {RemoteSettingsClient | null}
     */
    static "__#653@#languageIdModelsRemoteClient": RemoteSettingsClient | null;
    /**
     ...
     */
    static "__#653@#translationModelRecords": null | Promise<Map<string, TranslationModelRecord>>;
    /**
     * The RemoteSettingsClient that downloads the translation models.
     *
     * @type {RemoteSettingsClient | null}
     */
    static "__#653@#translationModelsRemoteClient": RemoteSettingsClient | null;
    /**
     * The RemoteSettingsClient that downloads the wasm binaries.
     *
     * @type {RemoteSettingsClient | null}
     */
    static "__#653@#translationsWasmRemoteClient": RemoteSettingsClient | null;
    /**
     * The page may auto-translate due to user settings. On a page restore, always
     * skip the page restore logic.
     */
    static "__#653@#isPageRestored": boolean;
    /**
     ...
     * @type {bool}
     */
    static "__#653@#isTranslationsEngineMocked": bool;
    /**
     ...
     * @type {string | null}
     */
    static "__#653@#mockedLangTag": string | null;
    /**
     * The language identification engine can be mocked for testing
     * by pre-defining this value.
     *
     * @type {number | null}
     */
    static "__#653@#mockedLanguageIdConfidence": number | null;
    /**
     * @type {null | Promise<boolean>}
     */
    static "__#653@#isTranslationsEngineSupported": null | Promise<boolean>;
    /**
     * When reloading the page, store the translation pair that needs translating.
     *
     * @type {null | TranslationPair}
     */
    static "__#653@#translateOnPageReload": null | TranslationPair;
    /**
     ...
     * @type {null | string[]}
     */
    static "__#653@#preferredLanguages": null | string[];
    /**
     * The value of navigator.languages.
     *
     * @type {null | Set<string>}
     */
    static "__#653@#webContentLanguages": null | Set<string>;
    static "__#653@#observingLanguages": boolean;
    static MAX_CONCURRENT_DOWNLOADS: number;
    static MAX_DOWNLOAD_RETRIES: number;
    static "__#653@#hostsOffered": Set<any>;
    ...
    static "__#653@#resetPreferredLanguages"(): void;
     ...
     * @returns {boolean}
     */
    static "__#653@#maybeAutoTranslate"(langTags: LangTags): boolean;
    /** @type {Promise<LanguageIdModelRecord> | null} */
    static "__#653@#languageIdModelRecord": Promise<LanguageIdModelRecord> | null;
    /**
     * Retrieves the language-identification model binary from remote settings.
     *
     * @returns {Promise<ArrayBuffer>}
     */
    static "__#653@#getLanguageIdModelArrayBuffer"(): Promise<ArrayBuffer>;
    /**
     * Initializes the RemoteSettingsClient for the language-identification model binary.
     *
     * @returns {RemoteSettingsClient}
     */
    static "__#653@#getLanguageIdModelRemoteClient"(): RemoteSettingsClient;
    /** @type {Promise<LanguageIdModelRecord> | null} */
    static "__#653@#languageIdWasmRecord": Promise<LanguageIdModelRecord> | null;
    /**
     * Retrieves the language-identification wasm binary from remote settings.
     *
     * @returns {Promise<ArrayBuffer>}
     */
    static "__#653@#getLanguageIdWasmArrayBuffer"(): Promise<ArrayBuffer>;
    /**
     ...
     */
    static "__#653@#languagePairs": Promise<Array<LanguagePair>> | null;
    /**
     ...
     */
    static "__#653@#handleTranslationsModelsSync"({ data: { created, updated, deleted }, }: {
        data: {
     ...
     * @returns {RemoteSettingsClient}
     */
    static "__#653@#getTranslationModelsRemoteClient"(): RemoteSettingsClient;
    /**
     ...
     */
    static "__#653@#getTranslationModelRecords"(): Promise<Map<string, TranslationModelRecord>>;
    /**
     ...
     * @returns {RemoteSettingsClient}
     */
    static "__#653@#getTranslationsWasmRemoteClient"(): RemoteSettingsClient;
    /** @type {Promise<WasmRecord> | null} */
    static "__#653@#bergamotWasmRecord": Promise<WasmRecord> | null;
    /**
     ...
     * @returns {Promise<ArrayBuffer>}
     */
    static "__#653@#getBergamotWasmArrayBuffer"(): Promise<ArrayBuffer>;
    /**
     ...
     */
    static "__#653@#locationChangeId": number;
     ...
     */
    static "__#653@#removeLangTagFromPref"(langTag: string, prefName: string): void;
    /**
     ...
     * @param {string} prefName - The pref name
     */
    static "__#653@#addLangTagToPref"(langTag: string, prefName: string): void;
    /**
