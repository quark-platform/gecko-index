...
export class Message {
     ...
     */
    static fromPacket(data: Array<number, number, unknown, unknown>): Message;
    /**
...
export class Command extends Message {
     ...
     *     If the message type is not recognised.
     */
    static fromPacket(payload: Array<number, number, any, any>): Command;
    constructor(messageID: any, name: any, params?: {});
    name: any;
    parameters: any;
    onerror: any;
    onresult: any;
...
export class Response extends Message {
     ...
     *     If the message type is not recognised.
     */
    static fromPacket(payload: Array<number, number, unknown, unknown>): Response;
    constructor(messageID: any, respHandler?: () => void);
    respHandler_: any;
    error: any;
    body: {
        value: any;
     ...
     */
    sendConditionally(predicate: (arg0: Response) => boolean): void;
    /**
...
export type ResponseCallback = (resp: Response) => any;
