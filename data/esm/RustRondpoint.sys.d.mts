export function copieDictionnaire(d: any): any;
export function copieEnumeration(e: any): any;
export function copieEnumerations(e: any): any;
export function copieCarte(c: any): any;
export function switcheroo(b: any): any;
...
export class Optionneur {
    ...
    sinonBoolean(value?: boolean): any;
    sinonString(value?: string): any;
    sinonSequence(value?: any[]): any;
    sinonNull(value?: any): any;
    sinonZero(value?: number): any;
    sinonU8Dec(value?: number): any;
    sinonI8Dec(value?: number): any;
    sinonU16Dec(value?: number): any;
    sinonI16Dec(value?: number): any;
    sinonU32Dec(value?: number): any;
    sinonI32Dec(value?: number): any;
    sinonU64Dec(value?: number): any;
    sinonI64Dec(value?: number): any;
    sinonU8Hex(value?: number): any;
    sinonI8Hex(value?: number): any;
    sinonU16Hex(value?: number): any;
    sinonI16Hex(value?: number): any;
    sinonU32Hex(value?: number): any;
    sinonI32Hex(value?: number): any;
    sinonU64Hex(value?: number): any;
    sinonI64Hex(value?: number): any;
    sinonU32Oct(value?: number): any;
    sinonF32(value?: number): any;
    sinonF64(value?: number): any;
    sinonEnum(value?: number): any;
    [uniffiObjectPtr]: any;
}
...
export class Retourneur {
    ...
    constructor(opts: any);
    identiqueI8(value: any): any;
    identiqueU8(value: any): any;
    identiqueI16(value: any): any;
    identiqueU16(value: any): any;
    identiqueI32(value: any): any;
    identiqueU32(value: any): any;
    identiqueI64(value: any): any;
    identiqueU64(value: any): any;
    identiqueFloat(value: any): any;
    identiqueDouble(value: any): any;
    identiqueBoolean(value: any): any;
    identiqueString(value: any): any;
    identiqueNombresSignes(value: any): any;
    identiqueNombres(value: any): any;
    identiqueOptionneurDictionnaire(value: any): any;
    [uniffiObjectPtr]: any;
}
...
export class Stringifier {
    ...
    constructor(opts: any);
    wellKnownString(value: any): any;
    toStringI8(value: any): any;
    toStringU8(value: any): any;
    toStringI16(value: any): any;
    toStringU16(value: any): any;
    toStringI32(value: any): any;
    toStringU32(value: any): any;
    toStringI64(value: any): any;
    toStringU64(value: any): any;
    toStringFloat(value: any): any;
    toStringDouble(value: any): any;
    toStringBoolean(value: any): any;
    [uniffiObjectPtr]: any;
}
