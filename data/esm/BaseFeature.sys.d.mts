...
export class BaseFeature {
     ...
     */
    queryRemoteSettings(searchString: string): any[];
    /**
     ...
     */
    onRemoteSettingsSync(rs: RemoteSettings): Promise<void>;
    /**
     ...
     */
    getSuggestionTelemetryType(suggestion: object): string;
    /**
     ...
     */
    makeResult(queryContext: UrlbarQueryContext, suggestion: object, searchString: string): UrlbarResult;
    /**
     * @returns {Logger}
