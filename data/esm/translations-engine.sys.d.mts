...
export class TranslationsEngine {
     ...
     */
    static "__#1803669@#cachedEngines": Map<string, Promise<TranslationsEngine>>;
    /**
     ...
     *                          parent process.
     */
    static "__#1803669@#removeEngineFromCache"(languagePairKey: string, force: boolean): void;
    /**
