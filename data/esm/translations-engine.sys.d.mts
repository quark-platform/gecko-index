...
export class TranslationsEngine {
     ...
     */
    static "__#1809424@#cachedEngines": Map<string, Promise<TranslationsEngine>>;
    /**
     ...
     *                          parent process.
     */
    static "__#1809424@#removeEngineFromCache"(languagePairKey: string, force: boolean): void;
    /**
