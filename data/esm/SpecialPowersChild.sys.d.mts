...
export class SpecialPowersChild extends JSWindowActorChild {
    ...
    _messageListeners: ExtensionUtils.DefaultMap;
    ...
    quit(): void;
    createFiles(fileRequests: any, onCreation: any, onError: any): Promise<any>;
    removeFiles(): void;
    executeAfterFlushingMessageQueue(aCallback: any): Promise<any>;
    ...
    loadChromeScript(urlOrFunction: any, sandboxOptions: any): {
        ...
        sendQuery: (name: any, message: any) => Promise<any>;
        destroy: () => void;
        receiveMessage: (aMessage: any) => any;
    };
    get Services(): typeof Services;
    get Cc(): {
    ...
    get Cu(): any;
    get Cr(): any;
    get ChromeUtils(): typeof ChromeUtils;
    get isHeadless(): any;
    get addProfilerMarker(): typeof ChromeUtils.addProfilerMarker;
    ...
    get InspectorUtils(): typeof InspectorUtils;
    get PromiseDebugging(): typeof PromiseDebugging;
    ...
    removePendingCrashDumpFiles(): Promise<any>;
    ...
    registerObservers(topic: any): Promise<any>;
    ...
    getBoolPref(...args: any[]): boolean;
    getIntPref(...args: any[]): number;
    getCharPref(...args: any[]): string;
    getComplexValue(prefName: any, iid: any): void;
    getStringPref(...args: any[]): string;
    ...
    setBoolPref(prefName: any, value: any): Promise<any>;
    setIntPref(prefName: any, value: any): Promise<any>;
    setCharPref(prefName: any, value: any): Promise<any>;
    setComplexValue(prefName: any, iid: any, value: any): Promise<any>;
    setStringPref(prefName: any, value: any): Promise<any>;
    clearUserPref(prefName: any): Promise<any>;
    ...
    _setPref(prefName: any, prefType: any, prefValue: any, iid: any): Promise<any>;
    ...
    effectiveIsolationStrategy(): number;
     ...
     */
    spawnChrome(args: any, task: any): Promise<any>;
    snapshotContext(target: any, rect: any, background: any, resetScrollPosition?: boolean): Promise<ImageBitmap>;
    getSecurityState(target: any): Promise<any>;
    ...
    removeAllServiceWorkerData(): Promise<any>;
    removeServiceWorkerDataForExampleDomain(): Promise<any>;
    cleanUpSTSData(origin: any, flags: any): Promise<any>;
