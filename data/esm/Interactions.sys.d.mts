...
declare class _Interactions {
     ...
     */
    static "__#567327@#updateInteraction_async"(browser: Browser, activeWindow: DOMWindow, userIsIdle: boolean, interactions: WeakMap<Browser, InteractionInfo>, pageViewStartTime: number, store: InteractionsStore): Promise<void>;
    DOCUMENT_TYPE: {
        GENERIC: number;
        MEDIA: number;
    };
