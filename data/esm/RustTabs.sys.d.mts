...
export class TabsBridgedEngine {
    ...
    lastSync(): any;
    setLastSync(lastSync: any): any;
    syncId(): any;
    resetSyncId(): any;
    ensureCurrentSyncId(newSyncId: any): any;
    prepareForSync(clientData: any): any;
    syncStarted(): any;
    storeIncoming(incomingEnvelopesAsJson: any): any;
    apply(): any;
    setUploaded(newTimestamp: any, uploadedIds: any): any;
    syncFinished(): any;
    reset(): any;
    wipe(): any;
    [uniffiObjectPtr]: any;
...
export class TabsStore {
    ...
    constructor(opts: any);
    getAll(): any;
    setLocalTabs(remoteTabs: any): any;
    registerWithSyncManager(): any;
    bridgedEngine(): any;
    [uniffiObjectPtr]: any;
}
