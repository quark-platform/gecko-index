...
* idlfile := contents={_ | CDATA | webidl | INCLUDE | interface_main | typedef | native | RAW_CODE_FRAGMENT | DOC_COMMENT}* $
...
export type idlfile_$0_2 = CDATA;
export type idlfile_$0_3 = webidl;
export type idlfile_$0_4 = INCLUDE;
export type idlfile_$0_5 = interface_main;
export type idlfile_$0_6 = typedef;
export type idlfile_$0_7 = native;
export type idlfile_$0_8 = RAW_CODE_FRAGMENT;
export type idlfile_$0_9 = DOC_COMMENT;
...
export class Parser {
    ...
    public matchinterface_main($$dpth: number, $$cr?: ErrorTracker): Nullable<interface_main> {
        return this.run<interface_main>($$dpth,
            () => {
                let $scope$doc_comment: Nullable<Nullable<DOC_COMMENT>>;
                ...
                if (true
                    && (($scope$doc_comment = this.matchDOC_COMMENT($$dpth + 1, $$cr)) || true)
                    ...
                    $$res = {kind: ASTKinds.interface_main, doc_comment: $scope$doc_comment, attrs: $scope$attrs, name: $scope$name, base: $scope$base, body: $scope$body};
                }
                return $$res;
            });
    }
